<div class="container-fluid">
    ...
    <div class="card shadow mb-4 ">
      ...
      <div class="card-body maxeder">
        <form action="<?= base_url('siswa/edit/'.$siswa->id_siswa) ?>" method="post">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nama" class="form-control" placeholder="Nama lengkap" value="<?= $siswa->nama_siswa?>">
